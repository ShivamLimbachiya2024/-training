...
const {renderRegister,userLogin,renderHomePage,registerUser,genForgotPass,renderFrgtPass,updateLink,renderPasspage,renderlogin,enterPass}=require('../controller/RegistrationLogin/controller.js')
const {runeventsPrac,runDynamicTable,runkukuCube,runticTacToe}=require('../controller/JSTaskController/controller.js')
const {runtask1,runtask2,runtask3}=require('../controller/CssController/controller')
const {listFunc,orderFunc}=require('../controller/PageController/controller')
const {repListStu,stulist,stuDetailResult}=require('../controller/ReportContoller/controller');
const {runQuery} = require("../controller/DeliSearchController/controller");
const {renderPage,renderDetailsPage}=require('../controller/FetchApiController/controller');
...
const {studentlist}=require('../controller/SearchSpecificField/SpecificSearchquery.js')
